        ...
        return (
            <div className="profile-card-page">
                <div className="profile-page-wrapper">
                    ...
                    <h3>{trip.city}</h3>
                    <h3>{trip.country}</h3>
                    <h3>Departure: {moment.utc(trip.startDate).format('MMM Do')}</h3>
                    <br />
                    ...
                    <br />
                    <br />
                    <button className="edit-btn" name="edit">Invite Traveler(s)</button>
                    <br />
                    <div className="trips-list-display">
                        <Link to='/groupinfo'><button className="edit-btn my-trips-list-title" name="edit">My Trips List</button></Link>
                    </div>
